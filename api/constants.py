...
from rdwv import COINS as _COINS

VERSION = "0.8.0.0"  # Version, used for openapi schemas and update checks
WEBSITE = "https://rdwv.app"  # rdwv official site
GIT_REPO_URL = "https://github.com/rdwv/rdwv"  # rdwv github repository
DOCKER_REPO_URL = "https://github.com/rdwv/rdwv-docker"  # rdwv Docker Packaging repository
...
PLUGINS_SCHEMA_URL = "https://rdwv.ai/schemas/plugin/1.2.0/plugin.schema.json"
