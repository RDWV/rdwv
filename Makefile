...
regtestln:
	rm -rf /tmp/rdwvln
	BTC_DEBUG=true BTC_DATA_PATH=/tmp/rdwvln BTC_NETWORK=regtest BTC_SERVER=127.0.0.1:51002:s BTC_LIGHTNING=true BTC_LIGHTNING_LISTEN=0.0.0.0:9735 BTC_PORT=5110 python3 daemons/btc.py
